        ...
        <div className="relative z-10 flex min-h-0 flex-1 flex-col pt-20 lg:pt-28">
          ...
          <div className="container mx-auto w-full shrink-0 px-4 pb-16 lg:px-8 lg:pb-24">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <p className="text-white/70 text-xs sm:text-sm uppercase tracking-wider mb-4">
                Earth · Wind · Wind Infinity · Sky · Sky Infinity
              </p>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {vf7Variants.map((v) => (
                  <button
                    ...
                    className={`rounded-full px-3 py-2 sm:px-4 text-xs sm:text-sm font-semibold transition-all border ${
                      variant === v.id
